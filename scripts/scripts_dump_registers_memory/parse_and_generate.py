            ...
            for line in file:
                ...
                if start_parsing:
                    ...
                    if len(parts) >= 2 and parts[0].startswith("0x"):
                        ...
                        end_addr = parts[1]
                        if (
                            "warning" not in start_addr.lower()
                            and "warning" not in end_addr.lower()
                        ):  # Additional check for the word 'warning'
...
if commands:
    ...
    print(
        "No commands generated. Check the format of the input file or script conditions."
    )
